    ...
    <div className="container mx-auto flex-grow flex items-center justify-center py-12 md:py-20 px-4 md:px-6">
      <Card className="max-w-5xl w-full animate-in fade-in zoom-in-95 duration-500">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl md:text-4xl font-bold animate-in fade-in slide-in-from-top-8 duration-700">About Beart India Group</CardTitle>
        </CardHeader>
        <CardContent className="animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
          <div className="prose prose-lg max-w-none mx-auto text-muted-foreground space-y-6 text-left">
            <p>
            ...
            <h2 className="text-2xl font-semibold text-foreground !mt-8 !mb-3">Our Mission</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-foreground !mt-8 !mb-3">Our Core Divisions</h2>

            <section>
              <h3 className="text-xl font-semibold text-foreground mb-2">1. Financial Services & Investment Advisory</h3>
              <p>
              ...
              <h4 className="text-lg font-medium text-foreground mt-4 mb-2">Our Services Include:</h4>
            ...
            <section className="!mt-6">
              <h3 className="text-xl font-semibold text-foreground mb-2">2. Digital Solutions for SMEs</h3>
              <p>
              ...
              <h4 className="text-lg font-medium text-foreground mt-4 mb-2">Our Digital Services Include:</h4>
              <ul className="list-disc list-inside space-y-1">
            ...
            <section className="!mt-6">
              <h3 className="text-xl font-semibold text-foreground mb-2">3. Beart Foundation – Our Social Arm</h3>
              <p>
            ...
            <h2 className="text-2xl font-semibold text-foreground !mt-8 !mb-3">Why Choose Beart India?</h2>
            <ul className="list-disc list-inside space-y-1">
