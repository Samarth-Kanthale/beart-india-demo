      ...
      <Card className="w-full max-w-3xl mx-auto shadow-xl animate-in fade-in zoom-in-95 duration-500 border-0 shadow-none">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-sm text-muted-foreground mt-2 animate-in fade-in slide-in-from-top-10 duration-700 delay-100">
            Published: May 18, 2025 | Read Time: 4 min
          </CardDescription>
        </CardHeader>
          ...
          <div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none mx-auto text-muted-foreground space-y-6 text-left">
            ...
            <ul className="space-y-3 list-none">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-foreground">Rupee Cost Averaging</h3>
                  <p>Investing regularly means buying more units when prices are low and fewer when prices are high, reducing the average cost per unit.</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <TrendingUp className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-foreground">Compounding Benefits</h3>
                  <p>Reinvesting returns leads to exponential growth over time.</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <Zap className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-foreground">Financial Discipline</h3>
                  <p>SIPs encourage regular saving and investing habits, essential for long-term wealth creation.</p>
                </div>
              </li>
            </ul>
