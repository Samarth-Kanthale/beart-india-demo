      ...
      <Card className="w-full max-w-3xl mx-auto shadow-xl animate-in fade-in zoom-in-95 duration-500 border-0 shadow-none">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-sm text-muted-foreground mt-2 animate-in fade-in slide-in-from-top-10 duration-700 delay-100">
            Published: May 20, 2025 | Read Time: 6 min
          </CardDescription>
        </CardHeader>
          ...
          <div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none mx-auto text-muted-foreground space-y-6 text-left">
            ...
            <ul className="space-y-3 list-none">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-foreground">Sector Representation</h3>
                  <p>The index includes companies from sectors like IT, finance, energy, and consumer goods, providing a comprehensive market overview.</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <CheckSquare className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-foreground">Investment Benchmark</h3>
                  <p>Many mutual funds and ETFs use the Nifty 50 as a benchmark, making it a critical reference point for investors.</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <TrendingUpIcon className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-foreground">Market Sentiment Indicator</h3>
                  <p>Movements in the Nifty 50 often indicate broader market trends and investor sentiment.</p>
                </div>
              </li>
            </ul>
