    ...
    <div className="container mx-auto flex-grow py-8 sm:py-12 md:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
       <Card className="max-w-2xl w-full mx-auto animate-in fade-in zoom-in-95 duration-500 border-0 shadow-none">
          ...
          <CardContent className="animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
             {/* Main container for the two sections, ensuring vertical stacking */}
             <div className="flex flex-col gap-8 md:gap-10 mb-8">
                 ...
                 {/* Get in Touch Directly Section */}
                 <div className="w-full text-center md:text-left">
                   <h3 className="text-lg sm:text-xl font-semibold mb-4">Get in Touch Directly</h3>
                   <div className="space-y-3 sm:space-y-4">
                     <Button size="lg" className="w-full justify-center md:justify-start gap-2 transform transition-transform hover:scale-105 text-sm sm:text-base btn-cta-custom" asChild>
                       <Link href="https://wa.me/919145656666" target="_blank" >
                         <MessageSquare className="h-4 w-4 sm:h-5 sm:w-5" /> WhatsApp Us (+91-9145656666)
                       </Link>
                     </Button>
                     <Button size="lg" variant="outline" asChild className="w-full justify-center md:justify-start gap-2 transform transition-transform hover:scale-105 text-sm sm:text-base">
