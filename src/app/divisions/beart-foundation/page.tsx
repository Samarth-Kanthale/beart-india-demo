...
// Placeholder icons if specific Lucide icons are not available or for custom representation
...
export default function BeartFoundationPage() {
  return (
    <div className="container mx-auto py-12 md:py-20 px-4 md:px-6 animate-in fade-in duration-500">
      <Card className="w-full mx-auto shadow-lg animate-in zoom-in-95 duration-500">
        ...
        <CardContent className="animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
          <div className="prose prose-lg max-w-none mx-auto text-muted-foreground space-y-6">
            ...
            <h2 className="text-2xl font-semibold text-foreground !mt-10 !mb-4 text-center md:text-left">What We Stand For</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-foreground !mt-10 !mb-4 text-center md:text-left">Our Core Focus Areas</h2>

            <section className="animate-in fade-in slide-in-from-left-12 duration-500 delay-300">
              <h3 className="flex items-center justify-center md:justify-start gap-2 text-xl font-semibold text-foreground mb-3">
            ...
            <h2 className="text-2xl font-semibold text-foreground !mt-10 !mb-4 text-center md:text-left">Our Vision</h2>
            <p className="text-center md:text-left">
             ...
             <div className="text-center !mt-12 animate-in fade-in zoom-in-90 duration-500 delay-600">
               <Button size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90 transform transition-transform hover:scale-105" asChild>
