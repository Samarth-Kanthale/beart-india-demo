...
export const metadata: Metadata = {
  title: 'Insurance Solutions - Beart India Group',
  description: 'Protect what matters most with Beart India Group. Explore Life Insurance and Health Insurance plans tailored to your needs. Secure your financial well-being.',
  keywords: ['insurance solutions India', 'life insurance', 'health insurance', 'Beart India insurance', 'financial protection'],
  alternates: {
      ...
      <Card className="w-full max-w-4xl mx-auto shadow-lg animate-in zoom-in-95 duration-500">
        ...
        <CardContent className="animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
          <div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none mx-auto text-muted-foreground space-y-6">
            ...
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground !mt-10 !mb-4">Our Insurance Offerings</h2>
             ...
             <h2 className="text-xl sm:text-2xl font-semibold text-foreground !mt-10 !mb-4">Why Choose Us for Insurance?</h2>
