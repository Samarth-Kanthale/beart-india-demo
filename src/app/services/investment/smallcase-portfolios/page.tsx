      ...
      <Card className="w-full max-w-4xl mx-auto shadow-xl animate-in fade-in zoom-in-95 duration-500 border-0 shadow-none">
        ...
        <CardContent className="animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
          ...
          <div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none mx-auto text-muted-foreground space-y-6 mb-12">
            ...
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground !mt-8 sm:!mt-10 !mb-3 sm:!mb-4">Key Features</h2>
            ...
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground !mt-8 sm:!mt-10 !mb-3 sm:!mb-4">Our Smallcase Services</h2>
             <ul className="space-y-2 sm:space-y-3 list-none">
                <li className="flex items-start gap-2">
              ...
              <h2 className="text-xl sm:text-2xl font-semibold text-foreground !mt-8 sm:!mt-10 !mb-3 sm:!mb-4">Tools &amp; Resources</h2>
               <div className="grid md:grid-cols-1 gap-4 mt-4">
                 <Button variant="outline" className="p-4 border rounded-lg bg-secondary transition-all duration-300 ease-in-out hover:shadow-lg hover:bg-accent w-full h-full flex flex-col items-start justify-start text-left text-sm sm:text-base" asChild>
                    <Link href="/calculators/sip">
                      ...
                      <p className="text-xs sm:text-sm text-muted-foreground overflow-visible whitespace-normal break-words">Estimate potential returns on your systematic investments.</p>
                      <span className="text-[hsl(var(--accent-investment))] font-medium text-xs sm:text-sm mt-auto">Open Calculator <ArrowRight className="inline-block ml-1 h-3 w-3 sm:h-4 sm:w-4" /></span>
                    </Link>
                  </Button>
               </div>

             <h2 className="text-xl sm:text-2xl font-semibold text-foreground !mt-8 sm:!mt-10 !mb-3 sm:!mb-4">How it Works</h2>
             <p>
             ...
             <h2 className="text-xl sm:text-2xl font-semibold text-foreground !mt-8 sm:!mt-10 !mb-3 sm:!mb-4">Who Is It For?</h2>
              <p>
