...
import { GraduationCap, ArrowRight, CheckCircle, Banknote, Globe, FileText, Calculator, Search, Percent, Users2Icon } from "lucide-react"; 
...
export const metadata: Metadata = {
  ...
  description: 'Secure education loans for studies in India and abroad. Beart India Group assists with eligibility, documentation, and finding the right lender.',
  keywords: ['education loans India', 'study abroad loans', 'student loans', 'HDFC education loan', 'ICICI education loan', 'Beart India education finance', 'EMI calculator'],
  alternates: {
      ...
      <Card className="w-full max-w-4xl mx-auto shadow-xl animate-in fade-in zoom-in-95 duration-500 border-0 shadow-none">
        ...
        <CardContent className="animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
          ...
          <div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none mx-auto text-muted-foreground space-y-6 mb-12">
            ...
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground !mt-10 !mb-4">Our Education Loan Services</h2>
             <ul className="space-y-2 sm:space-y-3 list-none">
                <li className="flex items-start gap-2 animate-in fade-in slide-in-from-left-12 duration-500 delay-300">
                 ...
                 <li className="flex items-start gap-2 animate-in fade-in slide-in-from-left-12 duration-500 delay-400">
                  ...
                  <span><span className="font-semibold text-foreground">Pre-Eligibility Checker:</span> Assess your likely loan eligibility based on basic criteria (API integration needed - requires partnership with lenders like HDFC, ICICI, CredAvenue).</span>
                </li>
               ...
               <h2 className="text-xl sm:text-2xl font-semibold text-foreground !mt-10 !mb-4">Tools &amp; Resources</h2>
               <div className="grid md:grid-cols-2 gap-4 mt-4">
                 <Button variant="outline" className="p-4 border rounded-lg bg-secondary transition-all duration-300 ease-in-out hover:shadow-lg hover:bg-accent animate-in zoom-in-95 duration-500 delay-800 w-full h-full flex flex-col items-start justify-start text-left text-sm sm:text-base" asChild>
                    <Link href="/calculators/emi">
                      ...
                      <p className="text-xs sm:text-sm text-muted-foreground overflow-visible whitespace-normal break-words">Estimate your monthly EMI payments.</p>
                       <span className="text-primary font-medium text-xs sm:text-sm mt-auto">Open Calculator <ArrowRight className="inline-block ml-1 h-3 w-3 sm:h-4 sm:w-4" /></span>
                    </Link>
                  </Button>
                  <div className="p-4 border rounded-lg bg-secondary transition-all duration-300 ease-in-out hover:shadow-lg hover:bg-accent animate-in zoom-in-95 duration-500 delay-900 flex flex-col items-start justify-start text-left">
                    ...
                    <h3 className="font-semibold text-foreground text-sm sm:text-base">Eligibility Check (Coming Soon)</h3>
            ...
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground !mt-10 !mb-4">How We Help</h2>
            <ul className="space-y-2 sm:space-y-3 list-none">
                  ...
                  <li className="flex items-start gap-2 animate-in fade-in slide-in-from-right-12 duration-500 delay-500">
                   ...
                   <li className="flex items-start gap-2 animate-in fade-in slide-in-from-right-12 duration-500 delay-600">
                    ...
                    <li className="flex items-start gap-2 animate-in fade-in slide-in-from-right-12 duration-500 delay-700">
                     <Users2Icon className="h-4 w-4 sm:h-5 sm:w-5 text-primary mt-1 shrink-0" />
             ...
             <h2 className="text-xl sm:text-2xl font-semibold text-foreground !mt-10 !mb-4">Key Benefits of Education Loans</h2>
