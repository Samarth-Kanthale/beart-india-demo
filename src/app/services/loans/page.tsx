...
export const metadata: Metadata = {
  title: 'Loan Facilitation Services - Beart India Group',
  description: 'Beart India Group assists in securing Home Loans, Education Loans, and Loans Against Mutual Funds. Guiding you through application to find competitive terms.',
  keywords: ['loan services India', 'home loan assistance', 'education loan India', 'loan against mutual funds', 'Beart India loans'],
  alternates: {
...
export default function LoansPage() {
  return (
    <div className="container mx-auto flex-grow py-12 md:py-20 px-4 md:px-6 animate-in fade-in duration-500">
      <Card className="w-full max-w-4xl mx-auto shadow-lg animate-in zoom-in-95 duration-500">
        ...
        <CardContent className="animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
          <div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none mx-auto text-muted-foreground space-y-6">
            ...
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground !mt-10 !mb-4">Our Loan Services</h2>
                  ...
                  <Link key={service.title} href={service.link} className="block hover:shadow-md transition-shadow duration-200 rounded-lg group">
                     <div className="p-4 border rounded-lg bg-card h-full flex flex-col animate-in fade-in zoom-in-95 duration-500" style={{ animationDelay: `${index * 100}ms` }}>
                       ...
                       <p className="text-sm text-muted-foreground flex-grow mb-3">
                        ...
                        <span className="text-primary font-medium text-sm mt-auto">Learn More <ArrowRight className="inline-block ml-1 h-4 w-4" /></span>
                     </div>
                  </Link>
                ))}
             </div>

             <h2 className="text-xl sm:text-2xl font-semibold text-foreground !mt-10 !mb-4">Why Use Our Facilitation Services?</h2>
