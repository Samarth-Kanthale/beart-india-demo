...
export function BlogPostCard({
  ...
  return (
    <Link href={link} target="_blank" rel="noopener noreferrer" className="block group h-full flex flex-col">
      <Card className="overflow-hidden flex flex-col flex-grow transition-all duration-300 ease-in-out group-hover:scale-105 group-hover:shadow-xl animate-in fade-in zoom-in-95 duration-500">
        ...
        <CardContent className="p-4 sm:p-6 flex flex-col flex-grow">
          ...
          <h3 className="text-lg sm:text-xl font-semibold mb-2 text-foreground group-hover:text-primary transition-colors duration-300 line-clamp-2">
            {title}
          </h3>
          <p className="text-muted-foreground text-sm mb-4 flex-grow line-clamp-3 sm:line-clamp-4">
            {description}
          </p>
